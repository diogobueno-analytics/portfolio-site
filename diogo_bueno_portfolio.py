...
curriculo_pdf = r"C:\Users\diogo\Documents\projetos_python\portfolio-site\Diogo Bueno - Currículo.pdf"
...
with aba_bio:
    ...
    with col1:
        # Aqui você coloca o seu código original de baixar currículo
        # Exemplo: st.download_button(label="Baixar Currículo", ...)
        st.markdown(link_curriculo, unsafe_allow_html=True) 

    with col2:
        st.markdown("""
            <a href="https://github.com/diogobueno-analytics" target="_blank" style="text-decoration: none;">
                <div style="background-color: #24292e; color: white; padding: 8px 16px; border-radius: 5px; text-align: center; display: flex; align-items: center; justify-content: center; gap: 8px; height: 40px;">
    ...
    with col3:
        st.markdown("""
            <a href="https://www.linkedin.com/in/diogobuenodarosa/" target="_blank" style="text-decoration: none;">
                <div style="background-color: #0077b5; color: white; padding: 8px 16px; border-radius: 5px; text-align: center; display: flex; align-items: center; justify-content: center; gap: 8px; height: 40px;">
