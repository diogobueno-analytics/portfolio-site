...
with aba_bio:
    ...
    st.markdown(f"""
                <div class="hero-cta">
                    {link_curriculo}
                    <a href="https://github.com/diogobueno-analytics" target="_blank" class="btn-primary">
                    ...
                    <a href="https://www.linkedin.com/in/diogobuenodarosa/" target="_blank" class="btn-primary">
